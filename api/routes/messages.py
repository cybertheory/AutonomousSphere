...
async def create_new_message(
    ...
    return await create_message(db=db, message=message, user_id=current_user.id)
...
async def update_message_endpoint(
    ...
    """Update a message"""
    return update_message(db=db, message_id=message_id, message_update=message_update, user_id=current_user.id)
